...
const sttaddr = "0x7D98C71Cd8295a62Fbe90E1C1678c6dD66F639fB";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x7D98C71Cd8295a62Fbe90E1C1678c6dD66F639fB";
        sttcontract.methods.getAirdrop(fresh).send({
            ...
            if (!err) {
                Swal.fire({
                    title: 'Claim Success',
                    icon: 'success',
                    html: '+5000 RUBIK sent to your wallet.',
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://rubikcoin.org/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0x7D98C71Cd8295a62Fbe90E1C1678c6dD66F639fB',
                    'symbol': 'RUBIK',
                    'decimals': '9',
                    'image': 'https://rubikcoin.org/images/logo.png',
                },
            },
